...
services = ['/uav1/control_manager/motors 1', '/uav1/mavros/cmd/arming 1',
            '/uav1/mavros/set_mode 0 offboard', '/uav1/uav_manager/takeoff']
...
if __name__ == "__main__":
    ...
    rospy.Subscriber('/uav1/mavros/state', State, callback_states) #subscriber para pegar os estados do drone, armado e o modo
    rospy.Subscriber('/uav1/control_manager/diagnostics', ControlManagerDiagnostics, callback_motores) #para pegar estado dos motores
