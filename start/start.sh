...
pre_input="export UAV_NAME=uav1; export RUN_TYPE=simulation"
...
"
  'Spawn' "waitForSimulation; spawn_uav 1 --file uav1_pos.txt --f450 --run --delete --enable-rangefinder --enable-rangefinder-up --enable-rplidar --enable-ground-truth --enable-bluefox-camera --enable-mobius-camera-back-left --enable-magnetic-gripper
"
